...
par(mfrow = c(2,2))
with(subset2, plot(datetime2, Global_active_power, type = "l", xlab = " ", ylab = "Global Active Power"))
with(subset2, plot(datetime2, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))
...
with(subset2, plot(datetime2, Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power"))
dev.off()